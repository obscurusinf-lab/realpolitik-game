...
const COUNTRY_INFO = {
  ...
  "Германия": { capital: "Берлин", gov: "Федеративная республика", flag: "🇩🇪", desc: "Локомотив ЕС. До 2022 г. — крупнейший торговый партнёр России в Европе. Сейчас лидирует в санкционной политике и поддержке Украины." },
