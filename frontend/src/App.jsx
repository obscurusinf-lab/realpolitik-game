        ...
        <div style={{ padding: "22px 22px 28px" }}>
          ...
          <BriefSection id="decisiontypes" label="🏛 ВКЛАДКА «КРЕМЛЬ»" color="#9c8347">
            ...
            <div className="doc-font" style={{ fontSize: 10.5, color: "#5a6070", lineHeight: 1.4, marginTop: 8 }}>
              33 готовые категории. Откройте карточку — появятся 3 готовые формулировки указа или поле для своего текста. Можно также писать правительству напрямую в свободном поле внизу экрана.
            </div>
          </BriefSection>
          ...
          <BriefSection id="howto" label="📖 КАК ИГРАТЬ" color="#5a6070">
            <div style={{ display: "grid", gap: 10 }}>
              {[
                ...
                ["2", "Откройте «Кремль»", "33 готовые категории по четырём направлениям (военное, разведка, дипломатия, указы). Разверните карточку — 3 готовые формулировки указа или своё поле для текста. Выбор остаётся во вкладке «Кремль», текст сам подставится в форму подписи внизу."],
  ...
  // 6. Коррупционная утечка казны
  {
    ...
    if (drain > 0) {
      mechanisms.push({
        ...
        trigger: `Коррупция ${corr} (индекс ${corruptionCpiEquivalent(corr)}/100 по методике Transparency International) — ₽${corruptionDrainRubTrillion(drain).toFixed(1)} трлн бюджета разворовывается ежемесячно`,
      ...
      mechanisms.push({
        active: false,
        name: "Коррупционная утечка",
        trigger: `Коррупция ${corr} (индекс ${corruptionCpiEquivalent(corr)}/100) ≤ 50 — утечки из казны нет`,
        impacts: [],
        fix: null,
      });
    }
...
const KREMLIN_CATEGORIES = {
  military: [
    ...
    { id: "mil_tactical", title: "Тактический удар", desc: "Точечный удар, локальная контратака, штурм позиции.", cost: "30 иниц. / 8 казны", effects: { military: 1, economy: -1, stability: -1, diplomacy: -1 },
      variants: [
    ...
    { id: "mil_operational_offensive", title: "Наступление", desc: "Наступательная операция на участке фронта, прорыв обороны.", cost: "55 иниц. / 20 казны", effects: { military: 1, economy: -1, stability: -1, diplomacy: -1 },
      variants: [
    ...
    { id: "mil_operational_defensive", title: "Оборона", desc: "Оборонительная операция, удержание рубежей, отход с выравниванием линии.", cost: "45 иниц. / 15 казны", effects: { military: 1, stability: 1, diplomacy: 1, approval: 1, economy: -1 },
      variants: [
    ...
    { id: "mil_strategic_offensive", title: "Стратегическое наступление", desc: "Наступление по всей линии фронта, масштабная мобилизация ресурсов.", cost: "80 иниц. / 35 казны", effects: { military: 1, economy: -1, stability: -1, diplomacy: -1 },
      variants: [
    ...
    { id: "mil_strategic_defensive", title: "Стратегическая оборона", desc: "Глубокоэшелонированная оборона, доктрина сдерживания (не ядерное применение).", cost: "60 иниц. / 25 казны", effects: { military: 1, stability: 1, diplomacy: 1, approval: 1, economy: -1 },
      variants: [
    ...
    { id: "mil_hybrid", title: "Гибридная война", desc: "ЧВК, партизанские операции, поддержка прокси-сил.", cost: "40 иниц. / 12 казны", effects: { military: 1, stability: 1, approval: 1, diplomacy: -1, economy: -1 },
      variants: [
  ...
  espionage: [
    ...
    { id: "covert_sabotage", title: "Диверсия", desc: "Диверсия против инфраструктуры противника. Высокий риск раскрытия.", cost: "40 иниц. / 15 казны", effects: { military: 1, economy: 1, diplomacy: -1, approval: 1 },
      variants: [
  ...
  diplomacy: [
    { id: "diplo_negotiate", title: "Переговоры", desc: "Обычные переговоры, визиты, дипломатические ноты.", cost: "35 иниц. / 5 казны", effects: { diplomacy: 1, economy: 1, stability: 1, approval: 1 },
      variants: [
    ...
    { id: "diplo_treaty", title: "Договор", desc: "Торговый, военный или гуманитарный договор — крупный долгосрочный эффект.", cost: "50 иниц. / 10 казны", effects: { diplomacy: 1, economy: 1, stability: 1, approval: 1 },
      variants: [
    ...
    { id: "diplo_pressure", title: "Давление", desc: "Ультиматум, санкции, заморозка активов, высылка дипломатов.", cost: "35 иниц. / 3 казны", effects: { diplomacy: -1, economy: -1, stability: -1 },
      variants: [
    ...
    { id: "diplo_multilateral", title: "Коалиция", desc: "Инициатива в ООН/БРИКС/ШОС, формирование коалиции, посредничество.", cost: "45 иниц. / 8 казны", effects: { diplomacy: 1, economy: 1, stability: 1, approval: 1 },
      variants: [
    ...
    { id: "diplo_soft_power", title: "Мягкая сила", desc: "Культурная дипломатия, гуманитарная помощь, образовательные программы.", cost: "25 иниц. / 8 казны", effects: { diplomacy: 1, economy: 1, stability: 1, approval: 1 },
      variants: [
    ...
    { id: "diplo_peace", title: "Мирная инициатива", desc: "Переговоры об урегулировании конфликта. Главный двигатель мирного трека — самая дешёвая из дипломатических операций.", cost: "30 иниц. / 5 казны", effects: { diplomacy: 1, economy: 1, stability: 1, approval: 1, military: -1 },
      variants: [
  ...
  decrees: [
    { id: "econ_stimulus", domain: "Экономика", title: "Стимулирование экономики", desc: "Льготы, инвестиции, субсидии, снижение ставки.", effects: { economy: 1, stability: 1, approval: 1 },
      variants: [
    ...
    { id: "econ_austerity", domain: "Экономика", title: "Жёсткая экономия", desc: "Сокращение расходов, налоги вверх — казна крепнет, но общество недовольно.", effects: { economy: 1, stability: -1, approval: -1 },
      variants: [
    ...
    { id: "econ_sanctions_counter", domain: "Экономика", title: "Контрсанкции", desc: "Параллельный импорт, обход ограничений, торговые партнёрства в обход Запада.", effects: { economy: 1, diplomacy: -1, stability: 1, approval: 1 },
      variants: [
    ...
    { id: "econ_tech", domain: "Экономика", title: "Технологии", desc: "НИОКР, космос, ИИ-суверенитет — небольшие затраты сейчас, рост экономики со временем.", effects: { military: 1, stability: 1, diplomacy: 1, approval: 1, economy: -1 },
      variants: [
    ...
    { id: "mil_admin_budget", domain: "Военно-административные", title: "Оборонный бюджет", desc: "Контракт с ВПК, увеличение расходов на оборону. НЕ боевая операция.", effects: { military: 1, stability: 1, economy: -1 },
      variants: [
    ...
    { id: "mil_admin_mobilization", domain: "Военно-административные", title: "Мобилизация", desc: "Указ о частичной мобилизации — растит армию ценой одобрения. НЕ боевая операция.", effects: { military: 1, stability: -1, approval: -1, economy: -1 },
      variants: [
    ...
    { id: "pol_liberalization", domain: "Политика", title: "Либерализация", desc: "Реформы, снятие ограничений, амнистия, свободы.", effects: { economy: 1, diplomacy: 1 },
      variants: [
    ...
    { id: "pol_social", domain: "Политика", title: "Социальная программа", desc: "Маткапитал, пенсии, здравоохранение, демография — двигает одобрение народа.", effects: { stability: 1, approval: 1, economy: -1 },
      variants: [
...
function buildCardVariants(card, tier) {
  const tierSet = DECREE_TIER_VARIANTS[card.id]?.[tier];
  if (Array.isArray(tierSet) && tierSet.length > 0) {
    return tierSet.map((text, i) => ({ label: `Вариант ${i + 1}`, text }));
  }
  if (Array.isArray(card.variants) && card.variants.length > 0) {
    return card.variants.map((text, i) => ({ label: `Вариант ${i + 1}`, text }));
  }
      ...
      <div style={sectionStyle}>
        ...
        <div style={{ background: "#14181f", borderRadius: 6, padding: "14px 16px", border: `1px solid ${ofzCount > 0 ? "#5a3a10" : "#2a3040"}` }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            >
              {loading === "repay" ? "Погашение…" : `💸 Погасить выпуск (−22 казны, премия за досрочный выкуп; давление инфляции −1)`}
            </button>
          </div>
...
function WikiTab({ dark = false }) {
  ...
  return (
    <div style={{ maxWidth: 680 }}>
      ...
      <div style={S.p}><span style={S.b}>ОФЗ (госдолг)</span> — быстрый способ пополнить казну на 20 пунктов, но не бесплатный обед: выпуск сразу добавляет давление инфляции +2 и −3 пункта/мес. на обслуживание, пока выпуск активен. Погашение стоит 22 пункта (премия за досрочный выкуп выше суммы, которую вы получили) и снимает только −1 давления инфляции — взять и тут же погасить выпуск всегда оставляет чистый минус в казне и +1 инфляции, это не бесплатный манёвр.</div>
      ...
      <div style={S.p}>Все решения президента сгруппированы во вкладке <span style={S.b}>Кремль</span> по четырём направлениям: <span style={S.b}>военное</span>, <span style={S.b}>разведка</span>, <span style={S.b}>дипломатия</span> и <span style={S.b}>указы</span> (экономика, военно-административные, политика, информационные). Внутри — 33 готовые категории решений: от разведки и точечных ударов до мобилизации, санкционного обхода и мирных инициатив. Откройте карточку категории — появятся 3 готовые, полностью сформулированные формулировки указа на выбор, либо можно написать собственный текст. Выбранный текст подставляется в поле подписи внизу экрана — оно видно на любой вкладке, переключаться никуда не нужно.</div>
      ...
      <div style={S.p}>Разведывательные и диверсионные операции (вкладка Кремль → «Разведка») несут <span style={S.b}>риск раскрытия</span>. Чем рискованнее операция (ликвидация опаснее дезинформации), тем выше шанс, что она попадёт в новости и ударит по дипломатии и рейтингу. В предпросмотре указа исход тайной операции не раскрывается заранее — вы подписываете указ, не зная наверняка, останется ли он в тени.</div>
