  ...
  // не начисляется, если коррупция выше 50 (там же, где начинается реальная утечка бюджета).
  {
    ...
    if (!hadEconomyHit && !corrupt && allHealthy) {
      ...
      mechanisms.push({
        ...
        trigger: `Экономика ${eco}, стабильность ${stab}, дипломатия ${dip}, рейтинг ${appr} — все здоровы, коррупция под контролем (${corrForDividend}), кризисов на экономику не было`,
      ...
      mechanisms.push({
        ...
        trigger: hadEconomyHit
          ...
          : corrupt
          ? `Коррупция ${corrForDividend} > 50 — бюджет разворовывается, "здоровое правление" не считается`
          : `Не все базовые статы ≥55 (экономика ${eco}, стабильность ${stab}, дипломатия ${dip}, рейтинг ${appr})`,
        impacts: [],
        fix: hadEconomyHit ? null : corrupt ? "Запустите антикоррупционную кампанию, чтобы сбить коррупцию ниже 50." : "Поднимите экономику, стабильность, дипломатию и рейтинг выше 55 одновременно и избегайте кризисов — тогда экономика начнёт расти сама по себе (+1, или +2, если все показатели выше 70).",
      });
    }
  }
