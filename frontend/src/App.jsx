...
function WikiTab({ dark = false }) {
  ...
  return (
    <div style={{ maxWidth: 680 }}>
      ...
      <div style={S.p}><span style={S.b}>Армия</span> — боеспособность вооружённых сил. Складывается из морального духа, готовности, техники и боевого опыта ветеранов — чем выше опыт войск, тем результативнее наступления. Военные операции двигают территории, но стоят инициативы и денег.</div>
