...
const KREMLIN_CATEGORIES = {
  military: [
    ...
    { id: "mil_tactical", title: "Тактический удар", desc: "Точечный удар, локальная контратака, штурм позиции.", cost: "30 иниц. / 8 казны", effects: { military: 1, stability: -1, diplomacy: -1 },
      variants: [
    ...
    { id: "mil_operational_offensive", title: "Наступление", desc: "Наступательная операция на участке фронта, прорыв обороны.", cost: "55 иниц. / 20 казны", effects: { military: 1, stability: -1, diplomacy: -1 },
      variants: [
    ...
    { id: "mil_operational_defensive", title: "Оборона", desc: "Оборонительная операция, удержание рубежей, отход с выравниванием линии.", cost: "45 иниц. / 15 казны", effects: { military: 1, stability: 1, diplomacy: 1, approval: 1 },
      variants: [
    ...
    { id: "mil_strategic_offensive", title: "Стратегическое наступление", desc: "Наступление по всей линии фронта, масштабная мобилизация ресурсов.", cost: "80 иниц. / 35 казны", effects: { military: 1, stability: -1, diplomacy: -1 },
      variants: [
    ...
    { id: "mil_strategic_defensive", title: "Стратегическая оборона", desc: "Глубокоэшелонированная оборона, доктрина сдерживания (не ядерное применение).", cost: "60 иниц. / 25 казны", effects: { military: 1, stability: 1, diplomacy: 1, approval: 1 },
      variants: [
    ...
    { id: "mil_hybrid", title: "Гибридная война", desc: "ЧВК, партизанские операции, поддержка прокси-сил.", cost: "40 иниц. / 12 казны", effects: { military: 1, stability: 1, approval: 1, diplomacy: -1 },
      variants: [
...
function WikiTab({ dark = false }) {
  ...
  return (
    <div style={{ maxWidth: 680 }}>
      ...
      <div style={S.p}><span style={S.b}>Организационный рост</span> — если экономика, стабильность, дипломатия и рейтинг одновременно выше 55, и в этом месяце не сработал ни один автоматический минус на экономику (ставка ЦБ, военное бремя, инфляция, дефицит казны, спад ВВП или занятости) — экономика получает +1 пункт сама по себе, +2, если все четыре показателя выше 70. Устойчивое здоровое правление должно давать отдачу, а не просто «не терять очки».</div>
