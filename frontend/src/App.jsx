    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.92)", zIndex: 2000, display: "flex", alignItems: "center", justifyContent: "center", padding: "16px" }}>
      <div style={{ background: "#14181f", border: "1px solid #3a4156", borderTop: "3px solid #9c8347", borderRadius: 6, maxWidth: 600, width: "100%", maxHeight: "92vh", overflow: "auto", boxShadow: "0 30px 80px rgba(0,0,0,0.8)" }}>
        ...
        <div style={{ padding: "22px 22px 28px" }}>
          ...
          {/* Условия победы — всегда видны. Числа тут ДОЛЖНЫ совпадать с реальным порогом
              дипломатической победы (detectGameOutcome в backend/turns.js: economy/approval/
              stability >= 65) — раньше здесь висели старые 55/60/60, оставшиеся от версии до
              правки MissionPanel/computeOptimalMove (2026-07-10), и расходились с настоящим
              порогом. Единственное место, где эти условия теперь объясняются в брифинге —
              подробности (военный путь, принуждение к миру и т.д.) смотрите в Ликбезе,
              не дублируем их тут второй раз (Петя, 2026-07-18: "все эти вкладки в брифинге
              будто лишние, всё же есть в ликбезе"). */}
          <div style={{ marginBottom: 14 }}>
            ...
            <div style={{ display: "grid", gap: 6, marginBottom: 16 }}>
              {[
                ...
                { label: "📈 Экономика ≥ 65", desc: "Рост ВВП, снижение инфляции, восстановление резервов после санкционного давления.", color: "#3a8a7a" },
                { label: "🗳 Рейтинг ≥ 65", desc: "Поддержка населения достаточна для легитимного управления страной.", color: "#8c6b3a" },
                { label: "🛡 Стабильность ≥ 65", desc: "Отсутствие серьёзных внутренних угроз, управляемое общество.", color: "#4a6b5c" },
