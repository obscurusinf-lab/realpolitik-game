...
const RU = {
  ...
  "wiki.kremlin.p3": "**Довольство элит — конечный ресурс.** Реакция всех четырёх башен на один и тот же указ центрируется вокруг нуля: если одна башня выигрывает заметно больше среднего, кто-то другой обязательно теряет. Указа, устраивающего сразу всех, не бывает — всегда стоит выбор, кому именно вы сейчас угождаете.",
