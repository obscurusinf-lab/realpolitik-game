...
const RU = {
  ...
  "start.mode_guided_title": "Обучение",
  "start.mode_guided_desc": "Пишите указы свободно, своими словами — что бы вы сделали как президент. Не нужно подбирать формулировки. Если что-то непонятно — любой министр в Кабинете объяснит простыми словами.",
  "guided.banner_title": "🎓 РЕЖИМ ОБУЧЕНИЯ",
  "guided.banner_text": "Вы — президент. Пишите ниже всё, что хотите сделать — своими словами, никаких специальных формулировок не нужно. Если что-то непонятно — загляните в «Управление → Кабинет министров»: там любой министр объяснит простыми словами, что делает и чем может помочь.",
...
const EN = {
  ...
  "start.mode_guided_title": "Guided",
  "start.mode_guided_desc": "Write decrees freely, in your own words — whatever you'd do as president. No need to guess the right phrasing. If something's unclear, any minister in the Cabinet will explain it in plain terms.",
  "guided.banner_title": "🎓 GUIDED MODE",
  "guided.banner_text": "You're the president. Write anything you want to do below — in your own words, no special phrasing needed. If something's unclear, check «Manage → Cabinet»: any minister will explain what they do and how they can help, in plain terms.",
