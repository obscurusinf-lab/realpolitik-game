...
const RU = {
  ...
  "start.auth_why": "Допуск нужен для того, чтобы партия сохранялась и была доступна с любого устройства — логин и пароль, без почты и подтверждений.",
  ...
  "start.field_invite_code": "КОД ПРИГЛАШЕНИЯ",
  "start.placeholder_invite_code": "выдан лично",
  "start.field_password": "ПАРОЛЬ",
  "start.password_show": "Показать пароль",
  "start.password_hide": "Скрыть пароль",
  ...
  "start.logout": "ВЫЙТИ",
  "start.session_expired": "Сессия истекла — войдите заново.",
  ...
  "start.mode_guided_title": "Новичок",
  "start.mode_guided_desc": "Первый раз в такой игре? Пишите указы своими словами — что бы вы сделали как президент, без специальных формулировок. Если что-то непонятно — министры в Кабинете всё разжуют максимально просто, шаг за шагом.",
  "guided.banner_title": "🐣 РЕЖИМ «НОВИЧОК»",
  "guided.banner_text": "Вы — президент. Пишите ниже всё, что хотите сделать — своими словами, ошибиться нельзя. Совсем не понимаете, что происходит? Загляните в «Управление → Кабинет министров»: там любой министр разложит всё по полочкам, максимально просто.",
  "guided.placeholder": "Например: «Хочу поддержать бизнес» или «Стоит договориться с Китаем»…",
  ...
  "start.make_public": "СДЕЛАТЬ ПАРТИЮ ПУБЛИЧНОЙ",
  "start.make_public_desc": "Партию целиком (ходы, статы, ленту новостей) смогут смотреть другие люди, пока вы играете — без права вмешаться.",
  ...
  "start.spectate": "👁 СМОТРЕТЬ ПАРТИИ",

  // ---- Зрительский режим (SpectatorView / PublicGamesPage) ----
  "spectate.title": "СМОТРЕТЬ ПАРТИИ",
  "spectate.subtitle": "Публичные партии других игроков — только просмотр, без права вмешаться.",
  "spectate.empty": "Пока нет публичных партий. Начните свою и отметьте «Сделать партию публичной» на старте.",
  "spectate.status_active": "в процессе",
  "spectate.readonly_badge": "ТОЛЬКО ПРОСМОТР",
  "spectate.peace_track": "Мирный трек",
  "spectate.stats_header": "ОБСТАНОВКА",
  "spectate.log_header": "ЛЕНТА ХОДОВ",
  "spectate.empty_log": "Партия только началась — ходов пока нет.",
  ...
  // ---- Onboarding tour ----
  "tour.replay_button": "🎓 ТУР",
  "tour.replay_title": "Показать тур по интерфейсу заново",
  "tour.step_counter": "ШАГ {n} ИЗ {total}",
  "tour.skip_button": "Пропустить",
  "tour.prev_button": "← Назад",
  "tour.next_button": "Далее →",
  "tour.finish_button": "Готово",
  "tour.auto_checkbox": "Показывать этот тур автоматически в новых партиях",
  "tour.step0_title": "Быстрый тур по интерфейсу",
  "tour.step0_body": "Покажем, что где находится — 9 коротких шагов, можно пропустить в любой момент кнопкой «Пропустить».",
  "tour.step1_title": "Обстановка",
  "tour.step1_body": "Сводка: новости, главные события, очаги напряжённости. Открывается первой при входе — сюда же ведёт совет аппарата (зелёная строка сверху, если он есть).",
  "tour.step2_title": "Управление",
  "tour.step2_body": "Внутренние дела страны: Кабинет министров, Башни Кремля (элиты), Казна. Клик открывает 3 под-вкладки снизу.",
  "tour.step3_title": "Кабинет министров",
  "tour.step3_body": "Здесь подписываются указы: у каждого министра своя область, кнопка «Распоряжения» открывает готовые категории, «Совет» — мнение министра.",
  "tour.step4_title": "Башни Кремля",
  "tour.step4_body": "4 группы элит (силовики, технократы, олигархи, консерваторы) — их лояльность и иногда дилеммы, где нужно выбрать чью сторону принять.",
  "tour.step5_title": "Казна",
  "tour.step5_body": "Бюджет, резервы ФНБ, облигации, ключевая ставка — все финансовые инструменты и их последствия.",
  "tour.step6_title": "Мир",
  "tour.step6_body": "Карта (общая и тактическая СВО) и Отношения с другими странами.",
  "tour.step7_title": "Прогресс",
  "tour.step7_body": "Все показатели страны по ходам и активные долгосрочные политики.",
  "tour.step8_title": "Ликбез",
  "tour.step8_body": "Полная справка по всем механикам игры — если что-то непонятно, здесь развёрнутый ответ.",
  "tour.step9_title": "Готово!",
  "tour.step9_body": "Тур можно перезапустить в любой момент кнопкой «🎓 ТУР» рядом с Ликбезом.",
  ...
  "tab.newsfeed": "Лента",
  "tab.log": "Журнал",
  "tab.desc_overview": "Сводка событий, новости, очаги напряжённости — стартовый экран после входа.",
  "tab.desc_military": "Боевые приказы напрямую — разведка, тактические/операционные/стратегические удары, гибридные операции.",
  "tab.desc_kremlin": "Фракции элит (силовики, технократы, олигархи, консерваторы) — их лояльность и дилеммы, где нужно выбрать чью сторону принять.",
  "tab.desc_advisors": "5 министров исполняют ваши указы: «Распоряжения» — готовые категории, «Совет» — мнение министра.",
  "tab.desc_treasury": "Бюджет, резервы ФНБ, облигации, ключевая ставка — финансовые инструменты.",
  "tab.desc_map": "Карта мира: расстановка сил, союзники/противники, тактический режим СВО.",
  "tab.desc_stats": "Все показатели страны и их динамика по ходам.",
  "tab.desc_policies": "Активные долгосрочные программы и сроки их завершения.",
  "tab.desc_relations": "Отношения с другими странами — от союзников до противников.",
  ...
  "wiki.overview.p2": "Каждый месяц вы принимаете решения — указы. Указ можно выбрать из готовых формулировок или написать своими словами, а игра сама классифицирует его по одному из направлений: **экономика и внутренняя политика** (реформы, программы, законы), **дипломатия** (переговоры, санкции, мирный трек), **военные операции** (наступления, оборона, мобилизация) и **разведка/тайные операции** (диверсии, дезинформация, ликвидации). Все они закреплены за конкретными министрами во вкладке «Кабинет министров».",
  ...
  "wiki.kremlin.h": "БАШНИ КРЕМЛЯ: ЭЛИТЫ, ЛОЯЛЬНОСТЬ И ДИЛЕММЫ",
  "wiki.kremlin.p1": "Башни Кремля — это не указы, а элитные группы, которые пытаются влиять на президента: **Силовики** 🎖 (силовой контур, спецслужбы), **Технократы** 🕊 (системные либералы, ЦБ), **Олигархи** 💰 (крупный бизнес, госконтракты) и **Консерваторы** ⛪ (охранительный, идеологический блок). В отличие от Кабинета министров, который исполняет ваши распоряжения, башни никому не подчиняются — они лоббируют собственные интересы, часто противоречащие друг другу, а президент здесь выступает арбитром.",
  "wiki.kremlin.p2": "У каждой башни есть **лояльность** (0-100, старт — нейтральные 65). Она не считается по отдельной таблице на все категории указов — башни реагируют на эффект, который ваш указ УЖЕ дал экономике, армии, дипломатии, стабильности, коррупции и изоляции в этом ходу. Указы, усиливающие армию, поднимают Силовиков; здоровый рост экономики без коррупции — Технократов; терпимость к коррупции и защита от изоляции — Олигархов; стабильность и патриотическая мобилизация — Консерваторов.",
  "wiki.kremlin.p3": "**Довольство элит — конечный ресурс.** Реакция всех четырёх башен на один и тот же указ центрируется вокруг нуля: если одна башня выигрывает заметно больше среднего, кто-то другой обязательно теряет. Указа, устраивающего сразу всех, не бывает — всегда стоит выбор, кому именно вы сейчас угождаете. Это фоновая реакция на КАЖДЫЙ указ — без выбора с вашей стороны, просто следствие того, что вы уже подписали. Явный выбор (в том числе компромисс) появляется только в карточках-дилеммах — см. ниже.",
  "wiki.kremlin.p4": "**Давление недовольства** — если лояльность башни падает ниже 60, включается нарастающая лестница дебаффов (ниже 60 → ниже 45 → ниже 30 → ниже 15), с каждым порогом эффекты сильнее и разнообразнее, тематически под домен башни: у Силовиков — готовность/боевой дух/армия, у Технократов — рост ВВП/инфляция/резервы, у Олигархов — казна/коррупция/изоляция, у Консерваторов — одобрение/стабильность. Это фоновое давление, проверяется раз в месяц, а не за каждый указ.",
  "wiki.kremlin.p5": "**Карточки-дилеммы** — когда пара башен расходится во мнениях достаточно резко, президенту предлагают вмешаться: **встать на сторону** одной башни (сильный, но вероятностный бафф + уникальный перк, при этом соперничающая башня резко теряет лояльность) или пойти на **компромисс** (небольшой гарантированный эффект всем сторонам понемногу, без резких потерь).",
  "wiki.kremlin.p6": "Компромисс — не бесплатный «безопасный выбор по умолчанию»: эффект от него заметно слабее, чем ставка на сторону, зато он не создаёт новых врагов. Каждый компромисс на 1 пункт заполняет шкалу **коалиционной стабильности** (максимум 5) — заполнив её целиком, вы немного снижаете риск случайных внутренних кризисов.",
  "wiki.kremlin.p7": "**Силовики и риск мятежа** — если лояльность Силовиков падает ниже 30, а общее довольство элит ниже 35, резко растёт шанс попытки мятежа силового блока в конце месяца. Подавление не гарантированно быстрое: есть риск, что инцидент перерастёт в тяжёлый внутренний кризис вместо того, чтобы обойтись малой кровью.",

  "wiki.ukraine.h": "УКРАИНА",
  "wiki.ukraine.p1": "У ВСУ показатели зеркалят российские: **армия** (боеспособность — как и у России, складывается из боевого духа, снаряжения, боеготовности и опыта войск), **поддержка Запада**, а также собственные экономика, дипломатия и внутренняя стабильность Украины. Украина выбирает стратегию каждый ход — военную, дипломатическую, экономическую, информационную или гибридную. При перегруппировке или передышке с вашей стороны противник использует паузу.",
  ...
  "wiki.ukraine.p4": "**ВСУ контратакует при каждом наступлении** — после любого наступательного удара противник случайно откатывает 1-3 участка фронта назад. Насколько сильно — зависит от **выучки вашей же армии** (боевой дух + боеготовность + опыт): чем она выше, тем слабее и реже контратака. Это не гарантия «сильная армия = контратак не будет» — шанс и интенсивность отката снижаются, но не обнуляются: даже при отличной подготовке Украине иногда везёт отбить территорию, просто это происходит реже и слабее, чем при слабой/уставшей армии.",
  ...
  "wiki.advisors.h": "КАБИНЕТ МИНИСТРОВ, УКАЗЫ И ВОЕННЫЕ ДЕЙСТВИЯ",
  "wiki.advisors.p1": "Кабинет министров исполняет решения президента (в отличие от башен Кремля — те лоббируют, но не исполняют, см. соседний раздел). Вы можете принять предложенный советником указ — или полностью сформулировать своё решение. Игра принимает любые реалистичные президентские решения: торговые договоры, кадровые назначения, законы, дипломатические ноты, военные приказы.",
  "wiki.advisors.p2": "У каждого министра — своя область указов, она раскрывается кнопкой **«Распоряжения ▼»** на его карточке: министр обороны отвечает за военные операции, глава СВР/безопасности — за шпионаж и внутреннюю безопасность, министр иностранных дел — за дипломатию, министр финансов — за экономические указы, пресс-секретарь — за информационную политику. Внутри каждой категории — 3 готовые, полностью сформулированные формулировки указа на выбор, либо можно написать собственный текст. Выбранный текст подставляется в поле подписи внизу экрана — оно видно на любой вкладке, переключаться никуда не нужно.",
  "wiki.advisors.p3": "Кроме готовых категорий, всегда доступно свободное поле «написать правительству» — президент может сформулировать любое реалистичное решение своими словами. Чем конкретнее формулировка, тем точнее игра рассчитает эффект.",
  "wiki.advisors.p4": "За кулисами игра ведёт независимый, не-ИИ расчёт «что реально горит прямо сейчас» (например: экономика на грани коллапса — сейчас не время для дорогих военных операций). Этот расчёт всегда «принадлежит» ОДНОМУ конкретному министру — тому, чья сфера ответственности совпадает с проблемой — и встраивается именно в его ответ, если спросить именно его в чате советников. Спросите другого советника — про этот расчёт он ничего не знает и отвечает исключительно из своей роли. Если чувствуете, что где-то поджимает — стоит спросить министра именно по этому направлению, не только своего любимого советника.",
  "wiki.advisors.p5": "**⚙ Перегруппировка** — подтягивает снабжение и резервы, восстанавливает инициативу. Главный эффект: открывает **второй военный удар в этом же месяце**. Цена: в этом месяце доступны только военные операции (это военное решение, не время для указов и дипломатии), а следующий месяц армия восстанавливается — боевые операции заблокированы. Исключение — **военная разведка**: она не требует отдыха войск, как бой, и остаётся доступна даже в месяц восстановления. Украина видит паузу и может атаковать.",
  "wiki.advisors.p6": "**🏠 Передышка** — президент занимается тылом: рейтинг, стабильность и занятость восстанавливаются. Доступна 1 раз за месяц. Цена: военные операции в этот месяц недоступны (президент занят тылом, не фронтом), а пока Россия отдыхает, ВСУ восстанавливают боевой дух и личный состав — фронт не двигается в вашу пользу.",
  "wiki.advisors.p7": "В каждом месяце доступна **одна** военная операция. Хотите нанести два удара подряд — сначала используйте перегруппировку: она открывает второй слот в текущем месяце, но блокирует военные (кроме разведки) в следующем.",
  "wiki.advisors.p8": "**Сопротивление ВСУ** — наступление не проходит бесплатно: каждый раз, когда войска продвигаются, ВСУ контратакуют и отбирают часть территории обратно — на любом направлении, включая Донецк и Луганск, не только на второстепенных участках фронта. Чем ниже боевой дух, готовность и опыт войск — тем сильнее откат. Наступление также стоит потерь боевого духа армии от самих боестолкновений — итоговый прирост территории и изменение духа в конце хода уже учитывают это сопротивление, это не отдельная случайность сверху.",
  "wiki.advisors.p9": "**Тайные операции** — разведывательные и диверсионные операции (раздел «Шпионаж» у секретаря Совбеза) несут **риск раскрытия**. Чем рискованнее операция (ликвидация опаснее дезинформации), тем выше шанс, что она попадёт в новости и ударит по дипломатии и рейтингу. В предпросмотре указа исход тайной операции не раскрывается заранее — вы подписываете указ, не зная наверняка, останется ли он в тени.",
  "wiki.advisors.p10": "**Усталость от повторных наступлений** — начиная со 2-го наступления подряд (тактического, оперативного, стратегического или гибридного) без паузы отдача от него снижается — идёт штраф к результату. Разведка сбрасывает этот счётчик на ноль (как и любое другое не-наступательное действие, кроме перегруппировки) — можно вставлять разведку между ударами, чтобы каждое следующее наступление снова считалось «первым» и не теряло в эффективности.",
  "wiki.advisors.p11": "**Дипломатия иногда стоит территории** — мирные и переговорные указы (в т.ч. мирная инициатива) слегка уступают спорные территории (Харьков и/или Херсон, до определённого предела) в обмен на движение мирного трека. Это осознанный компромисс: дипломатия с позиции силы не бесплатна — она может немного отодвинуть фронт ради прогресса к миру.",
  ...
  "treasury.jump.treasury": "💰 Казна",
  "treasury.jump.economy": "📈 Экономика",
  "treasury.jump.balance": "⚖️ Баланс",
  "treasury.jump.ofz": "📜 ОФЗ",
  "treasury.jump.keyrate": "🏦 Ставка",
  "treasury.jump.corruption": "🕵️ Коррупция",
  "treasury.jump.reserves": "💼 ФНБ",
  "treasury.jump.fxregime": "💱 Курс",
  "treasury.jump.inflation": "📊 Инфляция",
  "treasury.jump.oilfx": "🛢 Нефть",
  "treasury.w.treasury_title": "КАЗНА — ТЕКУЩЕЕ СОСТОЯНИЕ",
  "treasury.w.treasury_tooltip": "Итоговый остаток Казны — сюда стекаются все потоки из «Месячный баланс» ниже (налоги, нефть, курс минус программы, ОФЗ, утечка на коррупцию). При дефиците можно занять через ОФЗ или конвертировать часть резервов ФНБ.",
  "treasury.points": "{n} пунктов",
  "treasury.points_deficit": "{n} пунктов (ДЕФИЦИТ)",
  "treasury.per_month": "/ мес.",
  "treasury.forecast": "прогноз: ₽{n} трлн",
  "treasury.deficit_warning": "⚠ ДЕФИЦИТ КАЗНЫ — инфляция и экономика под давлением",
  "treasury.w.economy_title": "ЭКОНОМИКА — ЧТО ЕЁ ДВИГАЕТ",
  "treasury.w.economy_tooltip": "Экономика — главный источник налоговых поступлений в Казну (см. «Месячный баланс»): выше экономика и занятость — больше налогов. Рост ВВП определяет, куда экономика движется дальше.",
  ...
  "treasury.w.balance_tooltip": "Детальная разбивка того же числа «▲/▼ за месяц», что на карточке Казны выше — откуда приходят и куда уходят деньги.",
  ...
  "treasury.w.corruption_tooltip": "CPI (индекс восприятия коррупции) — выше значит ЛУЧШЕ, как в реальном рейтинге. Внутренний балл ниже устроен наоборот (выше = хуже) — используется для расчётов. Коррупция урезает часть доходов Казны и часть эффекта от указов.",
  ...
  "treasury.emergency_label": "⚠ ЭКСТРЕННОЕ СТИМУЛИРОВАНИЕ · ⚡40, −15 казны, −15 резервов ФНБ · раз в 4 хода",
  "treasury.emergency_desc": "Прямой укол экономике +10 немедленно — единственный мгновенный рычаг, когда всё остальное действует с лагом. Резервы ФНБ при этом СГОРАЮТ (не конвертируются в казну). Цена приходит после: инфляция +5 сразу, и ещё 3 месяца подряд −1 к экономике И +1 к инфляции («похмелье»). Не решение проблемы — окно, чтобы выиграть время.",
  ...
  "treasury.invest_locked": "🔒 Доступно при казне ≥ {threshold} (сейчас {treasury})",
  ...
  "treasury.bank_locked": "🔒 Доступно при казне ≥ {threshold} (сейчас {treasury})",

  "treasury.w.reserves_title": "РЕЗЕРВЫ (ФНБ)",
  "treasury.w.reserves_tooltip": "Резервы ФНБ — отдельная «подушка безопасности», не Казна. Приносят ежемесячный доход (направляется в резервы или в Казну на выбор). Часть можно конвертировать в Казну при нужде — но только один раз и необратимо.",
  ...
  "treasury.reserves_yield_label": "ДОХОДНОСТЬ ФНБ: {amount}/мес",
  "treasury.reserves_yield_to_reserves": "→ В резервы",
  "treasury.reserves_yield_to_treasury": "→ В казну",
  "treasury.reserves_yield_desc": "ФНБ инвестируется и приносит доход каждый месяц. Изоляция режет доходность, при сильной — уходит в минус (издержки обхода санкций). Выберите, куда идёт доход — бесплатно, менять можно в любой момент.",
  ...
  "treasury.w.fxregime_tooltip": "Режим курса рубля влияет на доход от нефти (см. «Нефтедоходы и валюта» ниже) и может расходовать резервы ФНБ на поддержание курса.",
  ...
  "treasury.w.inflation_tooltip": "Инфляция растёт от дефицита Казны и мягкой ключевой ставки ЦБ (см. виджет «Ставка»). Выше порога — ежемесячный штраф экономике и рейтингу.",
  ...
  "treasury.w.oilfx_tooltip": "Нефть и курс доллара — два внешних канала дохода Казны, независимые от ваших указов (тот же вклад виден строкой в «Месячном балансе»).",
  ...
  "policies.lower_class_mood_plain": "Настроение низов {sign}{n}",
  "policies.middle_class_plain": "Настроение среднего класса {sign}{n}",
  "policies.success_effects_header": "ПРИ УСПЕХЕ ВЫРАСТУТ",
  "policies.completion_condition_header": "ЦЕЛЬ ОПЕРАЦИИ (ориентир)",
  "policies.completion_condition_note": "Не гарантирует автоматическое завершение — операция снимается по истечении срока независимо от того, достигнута цель или нет.",
  ...
  "overview.advisor_teaser_label": "📐 СОВЕТ АППАРАТА",
  "overview.advisor_teaser_cta": "Кабинет министров →",
  "kremlin.dilemma_screen_header": "🏛 КРЕМЛЁВСКИЕ БАШНИ ТРЕБУЮТ РЕШЕНИЯ",
  "kremlin.dilemma_resolved": "Решение принято",
  "kremlin.coalition_stability_label": "Коалиционная стабильность",
  "kremlin.dilemma_continue": "Продолжить →",

  // ---- EndTurnScreen / PreviewCard: контратака ВСУ и западное вооружение ----
  "endturn.counterattack_header": "🇺🇦 КОНТРАТАКА ВСУ",
  "endturn.counterattack_western_arms_tag": "ЗАПАДНОЕ ВООРУЖЕНИЕ",
  "endturn.counterattack_intro": "ВСУ попытались контратаковать (интенсивность {n}/{max}) —",
  "endturn.counterattack_blunted_pre": "подготовка вашей армии (боеготовность {q})",
  "endturn.counterattack_blunted_bold": "сдержала удар",
  "endturn.counterattack_blunted_post": ", суммарный откат фронта всего −{n}%.",
  "endturn.counterattack_weak_pre": "слабая подготовка армии (боеготовность {q})",
  ...
  "preview.western_arms_triggered_label": "⚠ Запад поставляет новое вооружение ВСУ",
  "preview.western_arms_triggered_desc": "Серия безуспешных контратак ВСУ при подавляющем перевесе вашей армии — партнёры Украины усиливают её обороноспособность. Следующие контратаки будут ощутимо жёстче.",
  "preview.western_arms_streak_note": "🇺🇦 ВСУ на грани получения нового вооружения от Запада ({n}/2 провальных контратак подряд)",
  ...
  "map.tactical_hint": "красный — под контролем России, синий — под контролем ВСУ",
  "map.oblast_attribution": "контуры регионов: geoBoundaries.org",
  "map.zoom_in": "Приблизить",
  "map.zoom_out": "Отдалить",
  "map.zoom_reset": "Сбросить вид",
...
const EN = {
  ...
  "start.auth_why": "Clearance just keeps your game saved and accessible from any device — username and password, no email, no confirmations.",
  ...
  "start.field_invite_code": "INVITE CODE",
  "start.placeholder_invite_code": "given to you personally",
  "start.field_password": "PASSWORD",
  "start.password_show": "Show password",
  "start.password_hide": "Hide password",
  ...
  "start.session_expired": "Your session expired — please log in again.",
  ...
  "start.mode_guided_title": "Newcomer",
  "start.mode_guided_desc": "First time playing something like this? Write decrees in your own words — whatever you'd do as president, no special phrasing needed. If something's unclear, the ministers in the Cabinet will break it down as simply as it gets, step by step.",
  "guided.banner_title": "🐣 NEWCOMER MODE",
  "guided.banner_text": "You're the president. Write anything you want to do below — in your own words, you can't get it wrong. Not sure what's going on? Check «Manage → Cabinet»: any minister will spell it out in the simplest possible terms.",
  "guided.placeholder": "For example: \"I want to support small business\" or \"Time to negotiate with China\"…",
  ...
  "start.make_public": "MAKE GAME PUBLIC",
  "start.make_public_desc": "Others can watch the entire game (moves, stats, newsfeed) while you play — read-only, no way to interfere.",
  ...
  "start.spectate": "👁 WATCH GAMES",

  // ---- Spectator mode (SpectatorView / PublicGamesPage) ----
  "spectate.title": "WATCH GAMES",
  "spectate.subtitle": "Public games from other players — view only, no way to interfere.",
  "spectate.empty": "No public games yet. Start your own and check \"Make game public\" on the start screen.",
  "spectate.status_active": "in progress",
  "spectate.readonly_badge": "VIEW ONLY",
  "spectate.peace_track": "Peace track",
  "spectate.stats_header": "SITUATION",
  "spectate.log_header": "MOVE LOG",
  "spectate.empty_log": "The game just started — no moves yet.",
  ...
  // ---- Onboarding tour ----
  "tour.replay_button": "🎓 TOUR",
  "tour.replay_title": "Replay the interface tour",
  "tour.step_counter": "STEP {n} OF {total}",
  "tour.skip_button": "Skip",
  "tour.prev_button": "← Back",
  "tour.next_button": "Next →",
  "tour.finish_button": "Done",
  "tour.auto_checkbox": "Show this tour automatically in new games",
  "tour.step0_title": "Quick interface tour",
  "tour.step0_body": "We'll show what's where — 9 short steps, skip anytime with \"Skip\".",
  "tour.step1_title": "Overview",
  "tour.step1_body": "Digest: news, key events, hotspots. Opens first at login — the staff advice line (green bar at top, if present) also leads here.",
  "tour.step2_title": "Government",
  "tour.step2_body": "Internal affairs: Cabinet, Kremlin Towers (elites), Treasury. Clicking opens 3 sub-tabs below.",
  "tour.step3_title": "Cabinet",
  "tour.step3_body": "Decrees are signed here: each minister has their own domain, \"Orders\" opens ready-made categories, \"Advice\" gives the minister's opinion.",
  "tour.step4_title": "Kremlin Towers",
  "tour.step4_body": "4 elite factions (siloviki, technocrats, oligarchs, conservatives) — their loyalty and occasional dilemmas where you must pick a side.",
  "tour.step5_title": "Treasury",
  "tour.step5_body": "Budget, sovereign wealth reserves, bonds, key rate — all financial tools and their consequences.",
  "tour.step6_title": "World",
  "tour.step6_body": "Map (general and tactical SVO) and Relations with other countries.",
  "tour.step7_title": "Progress",
  "tour.step7_body": "All country indicators over turns and active long-term policies.",
  "tour.step8_title": "Guide",
  "tour.step8_body": "The full reference for every game mechanic — if something's unclear, the detailed answer is here.",
  "tour.step9_title": "Done!",
  "tour.step9_body": "Replay the tour anytime with the \"🎓 TOUR\" button next to Guide.",
  ...
  "tab.military": "Military operations",
  ...
  "tab.log": "Log",
  "tab.desc_overview": "Event digest, news, hotspots — the landing screen after login.",
  "tab.desc_military": "Combat orders directly — recon, tactical/operational/strategic strikes, hybrid operations.",
  "tab.desc_kremlin": "Elite factions (siloviki, technocrats, oligarchs, conservatives) — their loyalty and dilemmas where you must pick a side.",
  "tab.desc_advisors": "5 ministers execute your decrees: \"Orders\" opens ready-made categories, \"Advice\" gives the minister's opinion.",
  "tab.desc_treasury": "Budget, sovereign wealth reserves, bonds, key rate — the financial toolkit.",
  "tab.desc_map": "World map: force balance, allies/enemies, tactical SVO frontline mode.",
  "tab.desc_stats": "All country indicators and their trend over turns.",
  "tab.desc_policies": "Active long-term programs and their completion deadlines.",
  "tab.desc_relations": "Relations with other countries — from allies to enemies.",
  ...
  "wiki.kremlin.h": "KREMLIN TOWERS: ELITES, LOYALTY, AND DILEMMAS",
  "wiki.kremlin.p1": "The Kremlin Towers aren't decrees — they're elite groups trying to influence the president: **Siloviki** 🎖 (security services, military establishment), **Technocrats** 🕊 (systemic liberals, central bank), **Oligarchs** 💰 (big business, state contracts), and **Conservatives** ⛪ (the guardian, ideological bloc). Unlike the cabinet of ministers, which executes your decisions, the towers answer to no one — they lobby for their own interests, often at odds with each other, and the president acts as arbiter between them.",
  "wiki.kremlin.p2": "Each tower has **loyalty** (0-100, starting neutral at 65). It isn't tracked by a separate table across every decree category — instead, the towers react to the effect your decree ALREADY had on the economy, army, diplomacy, stability, corruption, and isolation this turn. Decrees that strengthen the army raise the Siloviki; healthy economic growth without corruption raises the Technocrats; tolerance for corruption and protection from isolation raise the Oligarchs; stability and patriotic mobilization raise the Conservatives.",
  "wiki.kremlin.p3": "**Elite satisfaction is a finite resource.** All four towers' reactions to the same decree are centered around zero: if one tower gains noticeably more than average, someone else necessarily loses. There's no decree that satisfies everyone at once — there's always a choice of exactly whom you're pleasing right now. This is a background reaction to EVERY decree — no choice on your part, just a consequence of what you already signed. An explicit choice (including a compromise) only shows up in dilemma cards — see below.",
  "wiki.kremlin.p4": "**Mounting pressure** — if a tower's loyalty drops below 60, an escalating debuff ladder kicks in (below 60 → below 45 → below 30 → below 15), with each threshold bringing stronger and more varied effects tied to that tower's domain: for the Siloviki it's readiness/morale/army, for the Technocrats it's GDP growth/inflation/reserves, for the Oligarchs it's treasury/corruption/isolation, for the Conservatives it's approval/stability. This is background pressure, checked once a month, not per decree.",
  "wiki.kremlin.p5": "**Dilemma cards** — when a pair of towers disagrees sharply enough, the president is asked to intervene: **side with** one tower (a strong but probabilistic buff plus a unique perk, while the rival tower's loyalty drops sharply) or go for a **compromise** (a small, guaranteed effect spread evenly, without sharp losses).",
  "wiki.kremlin.p6": "Compromise isn't a free \"safe default\" — its effect is noticeably weaker than siding with a tower, but it doesn't create new enemies. Every compromise fills the **coalition stability** meter by 1 point (max 5) — filling it completely slightly lowers the risk of random domestic crises.",
  "wiki.kremlin.p7": "**The Siloviki and mutiny risk** — if the Siloviki's loyalty drops below 30 and overall elite satisfaction is below 35, the chance of a security-bloc mutiny attempt at month's end rises sharply. Suppressing it isn't guaranteed to be quick — there's a real risk the incident escalates into a serious domestic crisis instead of being contained cheaply.",

  "wiki.ukraine.h": "UKRAINE",
  "wiki.ukraine.p1": "Ukraine's stats mirror Russia's: **army** (combat capability — like Russia's, made up of morale, equipment, readiness, and veteran experience), **Western support**, plus Ukraine's own economy, diplomacy, and internal stability. Ukraine picks a strategy every turn — military, diplomatic, economic, informational, or hybrid. When you regroup or take a breather, the opponent uses the pause.",
  ...
  "wiki.ukraine.p4": "**Ukraine counterattacks on every offensive** — after any offensive strike, the opponent randomly pushes back 1-3 front-line sectors. How hard depends on **your own army's training** (morale + readiness + experience): the higher it is, the weaker and rarer the counterattack. This isn't a guarantee that \"a strong army = no counterattacks\" — the odds and intensity shrink, but never hit zero: even against a top-tier force, Ukraine occasionally gets lucky and retakes ground, it just happens less often and less severely than against a weak or exhausted army.",
  ...
  "wiki.advisors.h": "THE CABINET OF MINISTERS, DECREES, AND MILITARY ACTIONS",
  "wiki.advisors.p1": "The cabinet of ministers executes the president's decisions (unlike the Kremlin Towers — those lobby but don't execute, see the neighboring section). You can accept an advisor's proposed decree — or phrase your own decision entirely. The game accepts any realistic presidential decision: trade deals, personnel appointments, laws, diplomatic notes, military orders.",
  "wiki.advisors.p2": "Each minister has their own area of decrees, revealed via the **\"Orders ▼\"** button on their card: the defense minister handles military operations, the security chief handles espionage and domestic security, the foreign minister handles diplomacy, the finance minister handles economic decrees, the press secretary handles information policy. Inside each category — 3 ready, fully worded decree phrasings to choose from, or you can write your own text. The chosen text is inserted into the signing field at the bottom of the screen — visible from any tab, no need to switch anywhere.",
  "wiki.advisors.p3": "Besides the ready-made categories, a free-text \"write to the government\" field is always available — the president can phrase any realistic decision in their own words. The more specific the wording, the more precisely the game calculates the effect.",
  "wiki.advisors.p4": "Behind the scenes, the game runs an independent, non-AI calculation of \"what's actually on fire right now\" (e.g., the economy is on the verge of collapse — now isn't the time for expensive military operations). This calculation always \"belongs\" to ONE specific minister — whoever's area of responsibility matches the problem — and gets woven into their answer only if you ask that particular one in the advisor chat. Ask a different advisor and they know nothing about it, answering purely from their own role. If you sense something is under pressure, it's worth asking the minister for that specific area, not just your favorite advisor.",
  "wiki.advisors.p5": "**⚙ Regroup** — restocks supplies and reserves, restores initiative. Main effect: opens up a **second military strike in the same month**. Cost: only military operations are available this month (it's a military decision, not the time for decrees and diplomacy), and next month the army is recovering — combat operations are blocked. Exception — **military reconnaissance**: it doesn't need the troops to rest like combat does, and stays available even in the recovery month. Ukraine sees the pause and may attack.",
  "wiki.advisors.p6": "**🏠 Breather** — the president focuses on the home front: approval, stability, and employment recover. Available once a month. Cost: military operations are unavailable this month (the president is busy with the home front, not the front line), and while Russia rests, Ukraine's forces restore morale and manpower — the front doesn't move in your favor.",
  "wiki.advisors.p7": "**One** military operation is available per month. Want to land two strikes in a row? Use regroup first: it opens a second slot this month, but blocks military actions (except recon) next month.",
  "wiki.advisors.p8": "**Ukrainian resistance** — an offensive doesn't come free: every time your troops advance, Ukraine's forces counterattack and take back part of the territory — on any front, including Donetsk and Luhansk, not just secondary sectors. The lower the morale, readiness, and troop experience, the stronger the pushback. An offensive also costs army morale from the fighting itself — the final territory gain and morale change at the end of the turn already account for this resistance, it's not a separate random layer on top.",
  "wiki.advisors.p9": "**Covert operations** — reconnaissance and sabotage operations (the security chief's \"Espionage\" section) carry a **risk of exposure**. The riskier the operation (assassination is riskier than disinformation), the higher the chance it hits the news and damages diplomacy and approval. In the decree preview, the outcome of a covert operation isn't revealed in advance — you sign the decree without knowing for sure whether it'll stay in the shadows.",
  "wiki.advisors.p10": "**Fatigue from repeated offensives** — starting with the 2nd offensive in a row (tactical, operational, strategic, or hybrid) without a break, its returns diminish — a penalty applies to the outcome. Reconnaissance resets this counter to zero (like any other non-offensive action except regroup) — you can insert recon between strikes so the next offensive counts as \"the first\" again and doesn't lose effectiveness.",
  "wiki.advisors.p11": "**Diplomacy sometimes costs territory** — peace and negotiation decrees (including the peace initiative) slightly concede contested territory (Kharkiv and/or Kherson, up to a certain limit) in exchange for peace-track progress. This is a deliberate trade-off: diplomacy from a position of strength isn't free — it can nudge the front back a little in exchange for progress toward peace.",
  ...
  // ---- TreasuryTab ----
  "treasury.trillion": "T",
  "treasury.jump.treasury": "💰 Treasury",
  "treasury.jump.economy": "📈 Economy",
  "treasury.jump.balance": "⚖️ Balance",
  "treasury.jump.ofz": "📜 Bonds",
  "treasury.jump.keyrate": "🏦 Rate",
  "treasury.jump.corruption": "🕵️ Corruption",
  "treasury.jump.reserves": "💼 Reserves",
  "treasury.jump.fxregime": "💱 FX",
  "treasury.jump.inflation": "📊 Inflation",
  "treasury.jump.oilfx": "🛢 Oil",
  "treasury.w.treasury_title": "TREASURY — CURRENT STATE",
  "treasury.w.treasury_tooltip": "The Treasury's final balance — fed by everything in \"Monthly Balance\" below (taxes, oil, exchange rate, minus programs, bonds, corruption leakage). When in deficit, you can borrow via bonds or convert part of the reserve fund.",
  ...
  "treasury.w.economy_tooltip": "The economy is the main source of tax income into the Treasury (see \"Monthly Balance\"): higher economy and employment mean more tax revenue. GDP growth determines where the economy heads next.",
  ...
  "treasury.w.balance_tooltip": "A detailed breakdown of the same \"▲/▼ per month\" figure shown on the Treasury card above — where the money comes from and where it goes.",
  ...
  "treasury.w.corruption_tooltip": "CPI (Corruption Perceptions Index) — higher is BETTER, same direction as the real-world ranking. The internal score below works the opposite way (higher = worse) and is used for calculations. Corruption skims part of Treasury income and part of decree/reform effects.",
  ...
  "treasury.emergency_label": "⚠ EMERGENCY STIMULUS · ⚡40, −15 treasury, −15 FNB reserves · once per 4 turns",
  "treasury.emergency_desc": "A direct +10 shot to the economy right now — the only instant lever when everything else acts with a lag. FNB reserves are BURNED (not converted to treasury). The price comes after: inflation +5 immediately, plus 3 months straight of −1 to the economy AND +1 to inflation (the \"hangover\"). Not a fix — a window to buy time.",
  ...
  "treasury.invest_locked": "🔒 Available at treasury ≥ {threshold} (now {treasury})",
  ...
  "treasury.bank_locked": "🔒 Available at treasury ≥ {threshold} (now {treasury})",

  "treasury.w.reserves_title": "RESERVES (NATIONAL WEALTH FUND)",
  "treasury.w.reserves_tooltip": "The reserve fund — a separate safety cushion, not the Treasury. Earns monthly yield (routed to reserves or straight to the Treasury, your choice). Part of it can be converted to the Treasury if needed — but only once, and it's irreversible.",
  ...
  "treasury.reserves_yield_label": "NWF YIELD: {amount}/mo",
  "treasury.reserves_yield_to_reserves": "→ Into reserves",
  "treasury.reserves_yield_to_treasury": "→ Into treasury",
  "treasury.reserves_yield_desc": "The NWF is invested and earns a return each month. Isolation cuts the yield — at high levels it goes negative (cost of evading sanctions). Choose where the yield goes — free, switch anytime.",
  ...
  "treasury.w.fxregime_tooltip": "The ruble's exchange-rate regime affects oil income (see \"Oil Revenue and Currency\" below) and can spend reserve-fund money to maintain the rate.",
  ...
  "treasury.w.inflation_tooltip": "Inflation rises from Treasury deficit and a loose central bank rate (see the \"Key Rate\" widget). Above the threshold, it's a monthly penalty to economy and approval.",
  ...
  "treasury.w.oilfx_tooltip": "Oil price and the dollar exchange rate are two external Treasury income channels, independent of your decrees (the same contribution appears as a line in \"Monthly Balance\").",
  ...
  "policies.lower_class_mood_plain": "Lower-class mood {sign}{n}",
  "policies.middle_class_plain": "Middle-class mood {sign}{n}",
  "policies.success_effects_header": "ON SUCCESS WILL RISE",
  "policies.completion_condition_header": "OPERATION GOAL (target)",
  "policies.completion_condition_note": "Does not guarantee automatic completion — the operation is lifted once its duration expires, whether or not the target was reached.",
  ...
  "overview.advisor_teaser_label": "📐 STAFF ADVICE",
  "overview.advisor_teaser_cta": "Cabinet →",
  "kremlin.dilemma_screen_header": "🏛 THE KREMLIN TOWERS DEMAND A DECISION",
  "kremlin.dilemma_resolved": "Decision made",
  "kremlin.coalition_stability_label": "Coalition stability",
  "kremlin.dilemma_continue": "Continue →",

  // ---- EndTurnScreen / PreviewCard: Ukraine counterattack and Western arms ----
  "endturn.counterattack_header": "🇺🇦 UKRAINE COUNTERATTACK",
  "endturn.counterattack_western_arms_tag": "WESTERN WEAPONS",
  "endturn.counterattack_intro": "Ukraine's forces attempted a counterattack (intensity {n}/{max}) —",
  "endturn.counterattack_blunted_pre": "your army's readiness (combat readiness {q})",
  "endturn.counterattack_blunted_bold": "held the line",
  "endturn.counterattack_blunted_post": ", the front only pulled back −{n}% overall.",
  "endturn.counterattack_weak_pre": "weak army preparation (combat readiness {q})",
  ...
  "preview.western_arms_triggered_label": "⚠ The West is supplying Ukraine with new weapons",
  "preview.western_arms_triggered_desc": "A string of failed Ukrainian counterattacks against your overwhelming army — Ukraine's partners are boosting its defense capability. Future counterattacks will be noticeably harsher.",
  "preview.western_arms_streak_note": "🇺🇦 Ukraine is on the verge of new Western arms shipments ({n}/2 failed counterattacks in a row)",
  ...
  "map.tactical_hint": "red = Russian-controlled, blue = Ukrainian-controlled",
  "map.oblast_attribution": "region outlines: geoBoundaries.org",
  "map.zoom_in": "Zoom in",
  "map.zoom_out": "Zoom out",
  "map.zoom_reset": "Reset view",
