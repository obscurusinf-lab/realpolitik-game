...
const RULES_TABLE = {
  ...
  null_action:             { economy:[-1,0],  military:[-1,0], stability:[0,0],  diplomacy:[0,0],  approval:[-1,0],  elite_satisfaction:[-1,0], corruption:[0,1],  middle_class:[-1,0], lower_class_mood:[-1,0],  gdp_growth:[-1,0], inflation:[0,1],  employment:[-1,0], reserves:[-1,0], army_morale:[-1,0], equipment:[-1,0], readiness:[-1,0], veterans:[0,0],  ally_trust:[-1,0], isolation:[0,1],  soft_power:[-1,0], reputation:[-1,0],  law_order:[-1,0], social_tension:[0,1],  media_control:[-1,0], regional_unity:[-1,0] },
